...
<body style="background-image: url('../images/ledesa-bg.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
...
<section class="show-products" style="padding-top: 0;">
   ...
   <div class="box">
      ...
      <div class="flex">
         ...
         <div class="category" style="color:brown"><?= $fetch_products['category']; ?></div>
      </div>
